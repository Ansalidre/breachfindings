      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p className="hero-text">
            Enter your business email or your company domain. BreachFindings
            shows a fast risk snapshot designed as a lead magnet for report
            requests and sales conversations.
          </p>
        </div>
